...
number=int(input("enter a negative interger number: "))#ask the user to enter a number
for i in range(number,1): #introducing a for loop condition
    print(i,end=" ")#this is for printing
